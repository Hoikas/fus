...
FUS_NET_STRUCT_BEGIN(auth_acctLoginRequest)
    FUS_NET_FIELD_UINT16(type)
    FUS_NET_FIELD_UINT32(transId)
...
FUS_NET_STRUCT_END(auth_acctLoginRequest)
...
FUS_NET_STRUCT_BEGIN(auth_acctLoginReply)
    FUS_NET_FIELD_UINT16(type)
    FUS_NET_FIELD_UINT32(transId)
...
FUS_NET_STRUCT_END(auth_acctLoginReply)
